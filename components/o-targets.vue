<template>
  <section class="o-targets -container -display-column -ip-display-row -ip-gap -mb-7 -md-mb-15">
    <div class="m-target__wrapper -p-3 -ip-pt-18 -lg-display-row -mb-2 -ip-mb-0 -col-12 -ip-col-4">
